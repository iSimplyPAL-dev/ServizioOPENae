...
Public Class ClsTracciato
    ...
    Public Function EstraiTracciato(ByVal sTributo As String, ByVal sAnnoRif As String, ByVal sCodiceISTAT As String, ByRef sNomeFileTracciati As String) As String
        ...
        Try
            Log.Debug("ClsTracciato::EstraiTracciato::inizio procedura")
            ...
            '*********************************************************************
            If oQueryManager.SetFlussoEstratto(oDBManager, sCodiceISTAT, sAnnoRif, sNomeFileTracciati, nRcFile) = -1 Then
                Return ""
            End If
            ...
            Log.Debug("ClsTracciato::EstraiTracciato::file da scaricare::" & sPathCartellaTracciatiCompleto)
            Log.Debug("ClsTracciato::EstraiTracciato::fine procedura")
            Return sPathCartellaTracciatiCompleto
        Catch Err As Exception
            Log.Debug("Si è verificato un errore in ClsTracciato::EstraiTracciato::" & Err.Message)
            Log.Warn("Si è verificato un errore in ClsTracciato::EstraiTracciato::" & Err.Message)
            Return ""
        End Try
    End Function
    ...
    Private Function WriteFile(ByVal sFile As String, ByVal DatiToPrint As String, ByVal ErrWriteFile As String) As Integer
        ...
        Try
            ...
            Return 1
        Catch Err As Exception
            Log.Debug("Si è verificato un errore in ClsTracciato::WriteFile::" & Err.Message)
            Log.Warn("Si è verificato un errore in ClsTracciato::WriteFile::" & Err.Message)
    ...
    Private Function TARSU_EstraiTracciato(ByVal dvMyDati As DataView, ByVal sPathCartellaTracciatiCompleto As String, ByRef nRcFile As Integer) As Boolean
        ...
        Try
            ...
            '***************************************************
            Log.Debug("ClsTracciato::TARSU_EstraiTracciato::Inizio a scrivere il seguente file:" & sPathCartellaTracciatiCompleto)
            ...
            Return True
        Catch Err As Exception
            Log.Debug("Si è verificato un errore in ClsTracciato::TARSU_EstraiTracciato::" & Err.Message)
            Log.Warn("Si è verificato un errore in ClsTracciato::TARSU_EstraiTracciato::" & Err.Message)
            Return False
        End Try
    End Function
    ...
    Private Function TARSU_WriteRcTesta(ByVal dvTesta As DataView, ByVal sPathCartellaTracciatiCompleto As String, ByRef nRcFile As Integer) As Boolean
        ...
        Try
            ...
            Return True
        Catch Err As Exception
            Log.Debug("Si è verificato un errore in ClsTracciato::EstraiTracciato::TARSU_WriteRcTesta::" & Err.Message)
            Log.Warn("Si è verificato un errore in ClsTracciato::EstraiTracciato::TARSU_WriteRcTesta::" & Err.Message)
            Return False
        End Try
    End Function
    ...
    Private Function TARSU_WriteRcCoda(ByVal oCoda As StructureTestaCoda, ByVal sPathCartellaTracciatiCompleto As String) As Boolean
        Try
            ...
            Return True
        Catch Err As Exception
            Log.Debug("Si è verificato un errore in ClsTracciato::EstraiTracciato::TARSU_WriteRcCoda::" & Err.Message)
            Log.Warn("Si è verificato un errore in ClsTracciato::EstraiTracciato::TARSU_WriteRcCoda::" & Err.Message)
            Return False
        End Try
    End Function
    ...
    Private Function TARSU_WriteRcDettaglio(ByVal dvDettaglio As DataView, ByVal nDett As Integer, ByVal sPathCartellaTracciatiCompleto As String, ByRef nRcFile As Integer) As Boolean
        ...
        Try
            ...
            Return True
        Catch Err As Exception
            Log.Debug("Si è verificato un errore in ClsTracciato::EstraiTracciato::TARSU_WriteRcDettaglio::" & Err.Message)
            Log.Warn("Si è verificato un errore in ClsTracciato::EstraiTracciato::TARSU_WriteRcDettaglio::" & Err.Message)
            Return False
        End Try
    End Function
    ...
    Private Function TARSU_FormattaRcTesta(ByVal MyRcTesta As StructureTestaCoda) As String
        ...
        Try
            Log.Debug("ClsTracciato::TARSU_FormattaRcTesta::inizio procedura")
            ...
            'Cognome
            sDatiTxt += oConst.FormattaPerTXT(MyRcTesta.sCognome).PadRight(26, " ")
            'Nome
            sDatiTxt += oConst.FormattaPerTXT(MyRcTesta.sNome).PadRight(25, " ")
            'sesso
            sDatiTxt += MyRcTesta.sSesso.PadRight(1, " ")
            'data nascita
            sDatiTxt += MyRcTesta.sDataNascita.PadRight(8, " ")
            'comune o stato estero di nascita
            sDatiTxt += oConst.FormattaPerTXT(MyRcTesta.sComuneNascita).PadRight(40, " ")
            'provincia di nascita
            sDatiTxt += MyRcTesta.sPvNascita.PadRight(2, " ")
            'Denominazione o Ragion Sociale
            sDatiTxt += oConst.FormattaPerTXT(MyRcTesta.sRagSociale).PadRight(60, " ")
            'Comune Sede
            sDatiTxt += oConst.FormattaPerTXT(MyRcTesta.sComuneSede).PadRight(40, " ")
            'Provincia Sede
            ...
            Log.Debug("ClsTracciato::TARSU_FormattaRcTesta::fine procedura")
        Catch Err As Exception
            Log.Debug("Si è verificato un errore in ClsTracciato::TARSU_FormattaRcTesta::" & Err.Message)
            Log.Warn("Si è verificato un errore in ClsTracciato::TARSU_FormattaRcTesta::" & Err.Message)
            sDatiTxt = ""
        End Try
        Return sDatiTxt
    End Function
    ...
    Private Function TARSU_FormattaRcDettaglio(ByVal MyRcDettaglio As StructureDettaglio) As String
        Dim sDatiTxt As String = ""
        Try
            Log.Debug("ClsTracciato::TARSU_FormattaRcDettaglio::inizio procedura")
            ...
            'Cognome
            sDatiTxt += oConst.FormattaPerTXT(MyRcDettaglio.sCognome).PadRight(26, " ")
            'Nome
            sDatiTxt += oConst.FormattaPerTXT(MyRcDettaglio.sNome).PadRight(25, " ")
            'Denominazione o Ragion Sociale
            sDatiTxt += oConst.FormattaPerTXT(MyRcDettaglio.sRagSociale).PadRight(50, " ")
            'Comune Sede
            sDatiTxt += oConst.FormattaPerTXT(MyRcDettaglio.sComuneSede).PadRight(40, " ")
            'Provincia Sede
            ...
            sDatiTxt += oConst.FormattaPerTXT(MyRcDettaglio.sComuneAmmUbicazione).PadRight(20, " ")
            ...
            sDatiTxt += oConst.FormattaPerTXT(MyRcDettaglio.sComuneCatUbicazione).PadRight(20, " ")
            'codice comune catastale
            ...
            'Via/Piazza/C.so
            sDatiTxt += oConst.FormattaPerTXT(MyRcDettaglio.sIndirizzo).PadRight(30, " ")
            'Civico
            ...
            Log.Debug("ClsTracciato::TARSU_FormattaRcDettaglio::fine procedura")
        Catch Err As Exception
            Log.Debug("Si è verificato un errore in ClsTracciato::TARSU_FormattaRcDettaglio::" & Err.Message)
            Log.Warn("Si è verificato un errore in ClsTracciato::TARSU_FormattaRcDettaglio::" & Err.Message)
            sDatiTxt = ""
        End Try
        Return sDatiTxt
    End Function
    ...
    Private Function TARSU_FormattaRcCoda(ByVal MyRcCoda As StructureTestaCoda) As String
        Dim sDatiTxt As String = ""
        Try
            Log.Debug("ClsTracciato::TARSU_FormattaRcCoda::inizio procedura")
            ...
            'Cognome
            sDatiTxt += oConst.FormattaPerTXT(MyRcCoda.sCognome).PadRight(26, " ")
            'Nome
            sDatiTxt += oConst.FormattaPerTXT(MyRcCoda.sNome).PadRight(25, " ")
            'sesso
            sDatiTxt += MyRcCoda.sSesso.PadRight(1, " ")
            'data nascita
            sDatiTxt += MyRcCoda.sDataNascita.PadRight(8, " ")
            'comune o stato estero di nascita
            sDatiTxt += oConst.FormattaPerTXT(MyRcCoda.sComuneNascita).PadRight(40, " ")
            'provincia di nascita
            sDatiTxt += MyRcCoda.sPvNascita.PadRight(2, " ")
            'Denominazione o Ragion Sociale
            sDatiTxt += oConst.FormattaPerTXT(MyRcCoda.sRagSociale).PadRight(60, " ")
            'Comune Sede
            sDatiTxt += oConst.FormattaPerTXT(MyRcCoda.sComuneSede).PadRight(40, " ")
            'Provincia Sede
            ...
            Log.Debug("ClsTracciato::TARSU_FormattaRcCoda::fine procedura")
        Catch Err As Exception
            Log.Debug("Si è verificato un errore in ClsTracciato::TARSU_FormattaRcCoda::" & Err.Message)
            Log.Warn("Si è verificato un errore in ClsTracciato::TARSU_FormattaRcCoda::" & Err.Message)
            sDatiTxt = ""
        End Try
        Return sDatiTxt
    End Function
    ...
    Private Function H2O_EstraiTracciato(ByVal dvMyDati As DataView, ByVal sPathCartellaTracciatiCompleto As String, ByRef nRcFile As Integer) As Boolean
        ...
        Try
            ...
            Return True
        Catch Err As Exception
            Log.Debug("Si è verificato un errore in ClsTracciato::H2O_EstraiTracciato::" & Err.Message)
            Log.Warn("Si è verificato un errore in ClsTracciato::H2O_EstraiTracciato::" & Err.Message)
            Return False
        End Try
    End Function
    ...
    Private Function H2O_WriteRcTesta(ByVal dvTesta As DataView, ByVal sPathCartellaTracciatiCompleto As String, ByRef nRcFile As Integer) As Boolean
        ...
        Try
            ...
            Return True
        Catch Err As Exception
            Log.Debug("Si è verificato un errore in ClsTracciato::EstraiTracciato::H2O_WriteRcTesta::" & Err.Message)
            Log.Warn("Si è verificato un errore in ClsTracciato::EstraiTracciato::H2O_WriteRcTesta::" & Err.Message)
            Return False
        End Try
    End Function
    ...
    Private Function H2O_WriteRcCoda(ByVal oCoda As StructureTestaCoda, ByVal sPathCartellaTracciatiCompleto As String) As Boolean
        Try
            ...
            Return True
        Catch Err As Exception
            Log.Debug("Si è verificato un errore in ClsTracciato::EstraiTracciato::H2O_WriteRcCoda::" & Err.Message)
            Log.Warn("Si è verificato un errore in ClsTracciato::EstraiTracciato::H2O_WriteRcCoda::" & Err.Message)
            Return False
        End Try
    End Function
    ...
    Private Function H2O_WriteRcDettaglio(ByVal dvDettaglio As DataView, ByVal nDett As Integer, ByVal sPathCartellaTracciatiCompleto As String, ByRef nRcFile As Integer) As Boolean
        ...
        Try
            ...
            Return True
        Catch Err As Exception
            Log.Debug("Si è verificato un errore in ClsTracciato::EstraiTracciato::H2O_WriteRcDettaglio::" & Err.Message)
            Log.Warn("Si è verificato un errore in ClsTracciato::EstraiTracciato::H2O_WriteRcDettaglio::" & Err.Message)
            Return False
        End Try
    End Function
    ...
    Private Function H2O_FormattaRcTesta(ByVal MyRcTesta As StructureTestaCoda) As String
        Dim sDatiTxt As String = ""
        Try
            Log.Debug("ClsTracciato::H2O_FormattaRcTesta::inizio procedura")
            'tipo record = Vale sempre 0
            sDatiTxt = oConst.TIPORCTESTA
            ...
            sDatiTxt += MyRcTesta.sCFPIVA.PadLeft(16, " ")
            'Denominazione o Ragion Sociale
            sDatiTxt += oConst.FormattaPerTXT(MyRcTesta.sRagSociale).PadRight(50, " ")
            'Comune Sede
            sDatiTxt += oConst.FormattaPerTXT(MyRcTesta.sComuneSede).PadRight(40, " ")
            'Provincia Sede
            sDatiTxt += MyRcTesta.sPvSede.PadRight(2, " ")
            ...
            Log.Debug("ClsTracciato::H2O_FormattaRcTesta::fine procedura")
        Catch Err As Exception
            Log.Debug("Si è verificato un errore in ClsTracciato::H2O_FormattaRcTesta::" & Err.Message)
            Log.Warn("Si è verificato un errore in ClsTracciato::H2O_FormattaRcTesta::" & Err.Message)
            sDatiTxt = ""
        End Try
        Return sDatiTxt
    End Function
    ...
    Private Function H2O_FormattaRcDettaglio(ByVal MyRcDettaglio As StructureDettaglio) As String
        Dim sDatiTxt As String = ""
        Try
            Log.Debug("ClsTracciato::H2O_FormattaRcDettaglio::inizio procedura")
            ...
            'comune di nascita
            sDatiTxt += oConst.FormattaPerTXT(MyRcDettaglio.sComuneNascita).PadRight(20, " ")
            'Provincia di nascita
            sDatiTxt += MyRcDettaglio.sPVNascita.PadRight(2, " ")
            'Denominazione o Ragion Sociale
            sDatiTxt += oConst.FormattaPerTXT(MyRcDettaglio.sRagSociale).PadRight(50, " ")
            'Comune Sede
            sDatiTxt += oConst.FormattaPerTXT(MyRcDettaglio.sComuneSede).PadRight(20, " ")
            'Provincia Sede
            sDatiTxt += MyRcDettaglio.sPvSede.PadRight(2, " ")
            'titolo occupazione
            sDatiTxt += MyRcDettaglio.sIdTitoloOccupazione
            'estremi contratto
            sDatiTxt += oConst.FormattaPerTXT(MyRcDettaglio.sEstremiContratto).PadRight(30, " ")
            ...
            sDatiTxt += MyRcDettaglio.sCodComuneUbicazCatast.PadRight(5, " ")
            'Via/Piazza/C.so
            sDatiTxt += oConst.FormattaPerTXT(MyRcDettaglio.sIndirizzo).PadRight(35, " ")
            'tipo unità
            sDatiTxt += MyRcDettaglio.sIdTipoUnita
            'sezione
            sDatiTxt += MyRcDettaglio.sSezione.PadRight(3, " ")
            ...
            Log.Debug("ClsTracciato::H2O_FormattaRcDettaglio::fine procedura")
        Catch Err As Exception
            Log.Debug("Si è verificato un errore in ClsTracciato::H2O_FormattaRcDettaglio::" & Err.Message)
            Log.Warn("Si è verificato un errore in ClsTracciato::H2O_FormattaRcDettaglio::" & Err.Message)
            sDatiTxt = ""
        End Try
        Return sDatiTxt
    End Function
    ...
    Private Function H2O_FormattaRcCoda(ByVal MyRcCoda As StructureTestaCoda) As String
        Dim sDatiTxt As String = ""
        Try
            Log.Debug("ClsTracciato::H2O_FormattaRcCoda::inizio procedura")
            ...
            Log.Debug("ClsTracciato::H2O_FormattaRcCoda::fine procedura")
        Catch Err As Exception
            Log.Debug("Si è verificato un errore in ClsTracciato::H2O_FormattaRcCoda::" & Err.Message)
            Log.Warn("Si è verificato un errore in ClsTracciato::H2O_FormattaRcCoda::" & Err.Message)
            sDatiTxt = ""
        End Try
        Return sDatiTxt
    End Function
